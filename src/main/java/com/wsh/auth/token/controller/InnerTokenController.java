package com.wsh.auth.token.controller;

import com.alibaba.fastjson.JSONObject;
import com.wsh.common.base.ResponseResult;
import com.wsh.common.constant.ErrorCode;
import com.wsh.common.exception.DataNotFoundException;
import com.wsh.common.exception.ParameterException;
...
import com.wsh.auth.token.api.ApiTokenService;
import com.wsh.auth.token.base.BaseToken;
import com.wsh.auth.token.base.TokenFactory;
import com.wsh.auth.token.base.TokenService;
import com.wsh.auth.token.base.TokenType;
...
//	}
	...
	public Object getAccessToken(@RequestBody JSONObject request) {
		...
		if (com.wsh.common.util.StringUtils.isEmptyStr(type)) {
			throw new DataNotFoundException("获取token校验失败,客户端标识不存在。");
		}
		// 根据类型获取具体的会话类型
		Class<? extends BaseToken> t = TokenType.getTokenClass(type);
